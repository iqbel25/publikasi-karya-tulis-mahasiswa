<div class="modal fade" id="dosenTambahModal" tabindex="-1" role="dialog" aria-labelledby="dosenTambahModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="dosenTambahModalLabel">Tambah Dosen</h5>
            ...
            <div class="modal-body">
                <form action="{{ route('dosen.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="jk" value="{{ old('jk') }}" id="jk">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="prodi" value="{{ old('prodi') }}" id="prodi">
                    ...
                    <div class="form-group">
                        ...
                        <input name="email" type="email" class="form-control @error('email') is-invalid @enderror"
                            value="{{ old('email') }}" id="email" placeholder="example@ft-umt.ac.id">
                    </div>
                    <div class="form-group">
