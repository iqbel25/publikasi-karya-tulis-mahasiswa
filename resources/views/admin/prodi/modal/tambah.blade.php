<div class="modal fade" id="prodiTambahModal" tabindex="-1" role="dialog" aria-labelledby="prodiTambahModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="prodiTambahModalLabel">Tambah Prodi</h5>
