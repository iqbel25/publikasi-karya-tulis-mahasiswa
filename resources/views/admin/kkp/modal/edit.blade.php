<div class="modal fade" id="kkpEditModal" tabindex="-1" role="dialog" aria-labelledby="kkpEditModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="kkpEditModalLabel">Edit Kkp</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form id="form-update-kkp" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                        <label for="nama_penulis" class="col-form-label">Nama Penulis :</label>
                        <input name="nama_penulis" type="text"
                            class="form-control @error('nama_penulis') is-invalid @enderror" id="edit-nama_penulis">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" readonly id="edit-tahun_lulus" name="tahun_lulus">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" readonly id="edit-prodi" name="prodi">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="abstrak" class="form-control kkp @error('abstrak') is-invalid @enderror"
                            id="edit-abstrak" cols="30" rows="3"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="bab1" class="col-form-label">Bab 1 :</label>
                        <a id="edit-bab1" download>Bab 1</a>
                    ...
                    <div class="form-group">
                        ...
                        <a id="edit-bab2" download>Bab 2</a>
                    ...
                    <div class="form-group">
                        ...
                        <a id="edit-bab3" download>Bab 3</a>
                    ...
                    <div class="form-group">
                        ...
                        <a id="edit-bab4" download>Bab 4</a>
