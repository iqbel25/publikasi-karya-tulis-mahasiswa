<div class="modal fade" id="kkpShowModal" tabindex="-1" role="dialog" aria-labelledby="kkpiShowModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="kkpShowModalLabel">Lihat Kkp</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form id="form-accept-kkp" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="modal-footer">
                        <input type="hidden" name="id" id="show-id-kkp">
