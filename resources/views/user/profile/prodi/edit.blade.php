<div class="modal fade" id="editProfileProdiModal" tabindex="-1" role="dialog"
    aria-labelledby="editProfileProdiModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editProfileProdiModalLabel">Edit Profile</h5>
            ...
            <div class="modal-body">
                <form id="form-update-prodi" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input name="nidn" type="text" class="form-control @error('nidn') is-invalid @enderror" id="edit-nidn-prodi">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="jk" id="edit-jk-prodi">
